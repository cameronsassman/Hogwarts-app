            ...
            <View style={styles.container} key={index}>
               <View style={styles.content}>
                  <View style={styles.card1}>
                      <Image 
                        style={styles.mrs} source={character.image ? { uri: character.image } : require('../../assets/Hogwarts/Defaults/SlytherinDefault.png')}
                      />
                  ...
                  <View style={styles.card2}>
                      ...
                      <Text style={styles.textTitle}>Speciess:</Text>
